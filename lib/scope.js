...
Scope.prototype.emit = function(token, data) {

  // Switch the scope to us.
  this.matcher.scope = this.constructor.name;

  // a bit weird, but works along with this.parent().emit();
  this.matcher.emit(token, data);
